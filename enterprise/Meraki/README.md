...
if network_id != "":
    try:
        ...
        pprint(e)developer:meraki-python-sdk > cat meraki_python_sdk_lab.py 
import meraki
import json
from pprint import pprint
...
if params["organization_id"] != "":
    try:
        networks = client.organizations.getOrganizationNe
developer:meraki-python-sdk > cat meraki_python_sdk_lab.py 
import meraki
import json
from pprint import pprint
